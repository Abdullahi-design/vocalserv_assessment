...
const EditEmployeeModal: React.FC<EditEmployeeModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm h-full w-full z-50 flex items-center justify-center p-4">
        <div className="relative w-full rounded-3xl max-w-lg overflow-y-auto h-full">
            <div className="bg-white/95 backdrop-blur-lg shadow-2xl rounded-3xl border border-white/20 p-8">
                ...
                <div className="text-center mb-8">
                    <div className="mx-auto w-12 h-12 bg-gradient-to-br from-emerald-500 to-green-600 rounded-2xl flex items-center justify-center mb-4">
                        <Edit className="h-5 w-5 text-white" />
                    </div>
                    <h3 className="text-sm font-bold text-slate-900 mb-2">Edit Employee</h3>
                    <p className="text-slate-600 text-xs">Update employee information</p>
                </div>
                ...
                <div className="flex justify-end space-x-4 mt-8">
                    ...
                    <button
                        onClick={onSubmit}
                        className="px-6 py-3 cursor-pointer text-sm font-semibold text-white bg-gradient-to-r from-emerald-600 to-green-600 rounded-xl hover:from-emerald-700 hover:to-green-700 transform hover:scale-105 transition-all shadow-lg"
                    >
                        Update Employee
                    </button>
                </div>
