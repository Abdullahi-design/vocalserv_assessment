  ...
  return (
    <div className="flex flex-col sm:flex-row gap-6 mb-8">
        ...
        <div className="sm:w-72">
            <select
            className="w-full px-4 py-2.5 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-blue-500/20 outline-none focus:border-blue-500 transition-all duration-200 bg-white/50 backdrop-blur-sm shadow-sm text-slate-900"
