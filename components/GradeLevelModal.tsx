      ...
      <div className="relative w-full max-w-lg">
        <div className="bg-white/95 backdrop-blur-lg shadow-2xl rounded-3xl border border-white/20 p-8">
          <div className="text-center mb-8">
            ...
            <h3 className="text-2xl font-bold text-slate-900 mb-2">Manage Grade Levels</h3>
            <p className="text-slate-600">Create and organize employee grade levels</p>
          </div>
          
          {/* Add new grade level */}
          <div className="space-y-6 mb-8 p-6 bg-gradient-to-r from-blue-50/50 to-indigo-50/50 rounded-2xl border border-blue-200/50">
            <h4 className="text-lg font-semibold text-slate-900 mb-4">Add New Grade Level</h4>
            <input
              type="text"
              placeholder="Grade Level Name (e.g., LVL6) *"
              className="w-full px-4 py-4 border border-slate-200 rounded-xl focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 transition-all bg-white/80 backdrop-blur-sm"
            ...
            <button
              ...
              className="w-full px-6 py-4 text-sm font-semibold text-white bg-gradient-to-r from-green-600 to-emerald-600 rounded-xl hover:from-green-700 hover:to-emerald-700 transform hover:scale-105 transition-all shadow-lg"
            >
              Add Grade Level
            </button>
          </div>
